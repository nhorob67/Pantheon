...
export function SocialProof() {
  return (
    <section className="quote-section">
      ...
      <div className="quote-sub">FarmClaw is built in Fargo, ND by a team that grew up on Upper Midwest row crop operations. We built this because we watched our families check elevator websites, weather apps, USDA reports, and text threads — every single morning — to make the same decisions. One conversation should be enough.</div>
