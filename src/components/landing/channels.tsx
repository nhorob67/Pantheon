  ...
  return (
    <section className="channels-section">
      <div style={{ textAlign: "center" as const }}>
        ...
        <p className="section-sub" style={{ margin: "16px auto 0" }}>Discord gives your team organized channels, role-based access, and a platform that works in the tractor and the office. No per-user fees. No message limits. Every conversation searchable and exportable.</p>
      </div>
