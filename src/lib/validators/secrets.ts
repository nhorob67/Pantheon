...
export const createSecretSchema = z.object({
  ...
  inject_scheme: z.enum(["bearer", "basic", "header", "query_param", "multi_header"]).default("bearer"),
...
export const updateSecretSchema = z.object({
  ...
  inject_scheme: z.enum(["bearer", "basic", "header", "query_param", "multi_header"]).optional(),
